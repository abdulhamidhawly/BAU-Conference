...
const Hero = () => {
  return (
    <>  
    <div className="relative sm:h-[625px] h-96 bg-tripoli bg-cover sm:bg-cover sm:bg-no-repeat bg-center sm:w-full mx-auto">
        ...
        <div className="text-4xl font-semibold max-sm:text-base max-sm:px-3 ">
          ...
          <p className="text-white">Bridging borders, Building futures.</p>
          <p className="text-slate-300 mt-2 font-bold md:text-5xl italic">YES WE CAN #2</p>
        </div>
        </div>
